        ...
        <form class="form-horizontal" method="post" action="" autocomplete="off">
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    ...
                    @include ('partials.forms.edit.location-select', ['translated_name' => trans('general.location'), 'fieldname' => 'assigned_location', 'company_id' => $license->company_id, 'style' => session('checkout_to_type') == 'location' ? '' : 'display: none;'])
